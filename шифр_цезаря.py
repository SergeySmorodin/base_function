# Этот способ шифрования использовал римский полководец Гай Юлий Цезарь для 
# секретной переписки со своими генералами.

# Для того, чтобы получить зашифрованное сообщение, каждый символ в тексте 
# заменяется символом, находящимся на постоянном числе позиций левее или правее него в алфавите.

# Например, при сдвиге вправо на 1, А будет заменена на Б, Б станет В, и так далее. 
# Последняя буква алфавита Я будет заменена на первую А.
...
# Твёрдый знак, перемещённый на три буквы вперёд, становится буквой «Э», буква «Я», перемещённая на три 
# буквы вперёд, становится буквой «В», и так далее. В результате из исходного алфавита

# А Б В Г Д Е Ё Ж З И Й К Л М Н О П Р С Т У Ф Х Ц Ч Ш Щ Ъ Ы Ь Э Ю Я
# получается зашифрованный

# Г Д Е Ё Ж З И Й К Л М Н О П Р С Т У Ф Х Ц Ч Ш Щ Ъ Ы Ь Э Ю Я А Б В 
# В этом уроке нужно написать программу с функцией encrypt. Эта функция должна принимать 
# два аргумента — исходную строку s и ключ k.
...
# Все, что нужно для решения этой задачи вы уже знаете, но небольшая подсказка 
# не помешает: используйте остаток от деления и строку, содержащую алфавит.

# При отрицательном значении аргумента k функция должна сдвигать символы не вправо, 
# а влево. Не забудьте проверить это.
